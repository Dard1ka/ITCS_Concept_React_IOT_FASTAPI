...
This project is a traffic light optimization system based on vehicle detection, PCU calculation, and automatic signal duration adjustment using Fuzzy Logic. The system integrates computer vision models with a FastAPI backend for AI inference and decision making, a React-based web dashboard for monitoring and visualization, and an IoT microcontroller to produce adaptive and real-time traffic light settings.
